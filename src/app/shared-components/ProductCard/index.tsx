// const ProductCard = ({image, title, price, originalPrice, rating, reviews, discount, buttonText}) => {
...
//                 <img src={`https://placehold.co/200x200/ffffff/cccccc?text=${title.replace(/\\s+/g, '')}`} alt={title} className="w-full h-36 object-cover rounded" />
...
export default function ProductCard({ image, title, price, oldPrice }: ProductCardProps) {
  return (
